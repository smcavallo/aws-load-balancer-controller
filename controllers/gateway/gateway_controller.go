...
func newGatewayReconciler(controllerName string, lbType elbv2model.LoadBalancerType, maxConcurrentReconciles int,
	gatewayTagPrefix string, finalizer string, certDiscovery certs.CertDiscovery, certImporter certs.CertImporter, routeLoader routeutils.Loader, serviceReferenceCounter referencecounter.ServiceReferenceCounter, routeFilter routeutils.LoadRouteFilter,
...
func (r *gatewayReconciler) reconcileUpdate(ctx context.Context, gw *gwv1.Gateway, stack core.Stack,
	...
	if err = r.updateGatewayStatusSuccess(ctx, lb.Status, gw, loaderResults); err != nil {
...
func (r *gatewayReconciler) updateGatewayStatusSuccess(ctx context.Context, lbStatus *elbv2model.LoadBalancerStatus, gw *gwv1.Gateway, loaderResults routeutils.LoaderResult) error {
...
func (r *gatewayReconciler) setupCommonGatewayControllerWatches(ctrl controller.Controller, mgr ctrl.Manager) error {
	...
	r.lbcEventChan = make(chan event.TypedGenericEvent[*elbv2gw.LoadBalancerConfiguration])
	...
	if err := ctrl.Watch(source.Channel(r.lbcEventChan, lbConfigEventHandler)); err != nil {
		return err
	}
